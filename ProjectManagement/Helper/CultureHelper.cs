...
namespace ProjectManagement.Helper
{
    ...
    public class CultureHelper
    {
        ...
        /// </summary>
        public static readonly List<CultureValuePairViewModel> Cultures = new List<CultureValuePairViewModel>()
        {
              new CultureValuePairViewModel()
              {
                  Text = "English",
                  Value = "en-AU"
              }, new CultureValuePairViewModel()
        ...
        /// </summary>
        /// <returns>returns culture name</returns>
        ...
        /// </summary>
        /// <returns>return Default culture</returns>
        ...
        /// <returns>returns implemented culture</returns>
        public static string GetImplementedCulture(string name)
        {
            ...
            if (Cultures.Where(c => c.Value.Equals(name, StringComparison.OrdinalIgnoreCase)).Any())
            {
        ...
        /// <summary>
        /// Gets neutral culture of a culture
        /// </summary>
        /// <param name="name">culture name</param>
        /// <returns>return first two chars only of the culture name</returns>
        ...
        /// </summary>
        /// <returns>returns is right to left</returns>
