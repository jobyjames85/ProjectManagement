...
namespace ProjectData
{
    ...
    public partial class ProjectHeaderChangeTypeMonthWiseLog
    {
        public long ProjectHeaderChangeTypeMonthWiseLogID { get; set; }
        public Nullable<long> ProjectsPMCSRCMMonthwiseLogId { get; set; }
        public Nullable<long> ProjectsRMCSRCMMonthwiseLogId { get; set; }
        public long ProjectChangeTypeId { get; set; }
